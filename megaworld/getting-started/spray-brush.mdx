...
description: "Paint objects into the scene one at a time using a brush with simple filters and overlap checking."
---
...
In the **Selection Panel**, click **Add Type** and choose **Terrain Object**, **Unity/GameObject**, or **Unity/Terrain Tree**. Inside the group, click **Add Resource** and add the prefabs you want to place.
