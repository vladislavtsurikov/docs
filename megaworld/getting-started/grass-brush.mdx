...
In the **Selection Panel**, right-click in the Groups panel and choose **Create Group**. Inside the Group, click **Add Resource** and choose **Unity/Terrain Detail**.
...
- Use [Advanced Object Brush](/megaworld/getting-started/advanced-object-brush) to paint trees or rocks in the same session.
