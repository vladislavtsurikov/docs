...
Terrain Object types show a **Get Resources** action.

Use **Get Resources** to read prototypes from the active Terrain Object Renderer selection data and add any missing prefab prototypes to the MegaWorld Type. This is useful when the renderer already has the object set configured and you want MegaWorld tools to use the same resources.
