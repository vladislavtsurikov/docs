...
Groups in Grass Stamper are separate from object Groups but live in the same MegaWorld data system. Use Grass Stamper alongside [Object Stamper](/megaworld/tools/object-stamper) so your vegetation detail and object placement share the same stamper workflow and can be tuned together.
