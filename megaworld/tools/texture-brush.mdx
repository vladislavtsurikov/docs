...
<Note>
  For stamping terrain textures over a large area procedurally, use [Texture Stamper](/megaworld/tools/texture-stamper). For painting GameObjects, use [Advanced Object Brush](/megaworld/tools/advanced-object-brush). For painting grass, use [Grass Brush](/megaworld/tools/grass-brush).
</Note>
