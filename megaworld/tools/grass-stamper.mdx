...
<Note>
  For spawning GameObjects, Terrain Objects, and Unity Terrain Trees, use [Advanced Object Stamper](/megaworld/tools/advanced-object-stamper). For painting terrain textures, use [Texture Stamper](/megaworld/tools/texture-stamper).
</Note>
...
| **Spawn** | Not spawning, Auto Respawn off | Runs the full detail spawn pass. |
| **Respawn** | Always | Clears the current detail pass and runs a fresh spawn. |
| **Unspawn Selected Prototypes** | Always | Removes the detail layer data for the currently selected prototypes (shows a confirmation dialog). |
