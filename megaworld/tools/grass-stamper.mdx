...
<Note>
  For spawning GameObjects and Terrain Objects, use [Object Stamper](/megaworld/tools/object-stamper). For painting terrain textures, use [Texture Stamper](/megaworld/tools/texture-stamper).
</Note>
