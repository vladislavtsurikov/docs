...
<Info>
  New to Object Stamper? Follow the step-by-step [Object Stamper — Getting Started](/megaworld/getting-started/object-stamper) tutorial first.
</Info>
...
- Object Stamper does not support Unity/Terrain Detail. Use [Grass Stamper](/megaworld/tools/grass-stamper) for grass and detail density passes.
- Object Stamper does not support Unity/Terrain Texture. Use [Texture Stamper](/megaworld/tools/texture-stamper) for terrain texture passes.
