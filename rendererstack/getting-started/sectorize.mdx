...
- At least one camera in [Cameras](/rendererstack/scene-settings/cameras).
...
Open Sectorize in RendererStack.
...
Sectorize uses the shared [Cameras](/rendererstack/scene-settings/cameras) scene setting.

Every active non-ignored camera can load sectors. During each render update, Sectorize checks sectors around the camera position and applies the active [Streaming Rules](/rendererstack/sectorize/settings/streaming-rules).
...
- [Immediately Loading](/rendererstack/sectorize/streaming-rules/immediately-loading) loads close sectors right away.
- [Asynchronous Loading](/rendererstack/sectorize/streaming-rules/asynchronous-loading) loads farther sectors with pauses.
- [Preventing Unloading](/rendererstack/sectorize/streaming-rules/preventing-unloading) keeps sectors loaded near the camera.
- [Caching](/rendererstack/sectorize/streaming-rules/caching) keeps recently unloaded scenes inactive for a limited time.
